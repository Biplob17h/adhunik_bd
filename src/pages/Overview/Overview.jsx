...
import FixedServiceCard from "./FixedServiceCard/FixedServiceCard";
        ...
        <div className="container xl:max-w-[1200px] mx-auto">
          <div className="row flex">
            <div className="sidebar col-md-3">
              <div className="flex flex-col opacity-60 font-semibold text-[18px] w-[180px] gap-4 py-3 sticky top-[5rem]">
                <Link className="sidebarone" to={"/#"}>
                  Service Overview
                </Link>
                <Link to={"/#"}>FAQ</Link>
